...
L["CHINA"] = "Promotion available only in China."
L["Chintoka"] = true
L["Chub"] = true
L["Cielstrasza"] = true
...
L["CRANENEST"] = "Chance of dropping from Crane Nests on Timeless Isle - they can be found under trees near groups of various Cranes."
...
L["DARTSNEST"] = "Found in Dart's Nest - 4 spawn locations all close by 46.5, 17.2"
...
L["DIREHORN"] = "The mob this mount drops from can spawn in 1 of 4 spots randomly: Townlong Steppes: 36.6, 85.6, Dread Wastes: 47.2, 61.6, Kun-Lai Summit: 75.0, 67.6, Jade Forest: 52.6, 19.0"
...
L["Ravika"] = true
L["Ray'ma"] = true
L["RAZORMAWNEST"] = "Found in the Razormaw Matriarch's Nest."
...
L["Retired"] = true
L["RETIRED_COLLECTABLE_LONG"] = "This collectable is retired from the game.  This means that it is no longer availible to acquire by normal means."
...
L["STORE"] = "Purchased from Blizzard Store."
...
L["TAKKSNEST"] = "Available from Takk's Nest, which spawns in Northern Barrens under trees, between Far Watch Post and Nozzlepot's Outpost."
L["Tanaika"] = true
