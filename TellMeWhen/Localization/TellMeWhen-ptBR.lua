...
L["ANIM_ICONSHAKE_DESC"] = "Treme o ícone quando é acionado." -- Needs review
L["ANIM_PERIOD"] = "Período de Flash" -- Needs review
L["ANIM_SCREENFLASH"] = "Tela: Flash" -- Needs review
L["ANIM_SCREENFLASH_DESC"] = "Pisca uma camada colorida sobreposta na tela." -- Needs review
L["ANIM_SCREENSHAKE_DESC"] = [=[Treme a sua tela quando é acionado.

NOTA: Isso só vai funcionar se você estiver fora de combate ou se as nameplates não tiverem sido ativadas desde que você logou.]=] -- Needs review
...
L["CLEU_SPELL_AURA_BROKEN_SPELL_DESC"] = [=[Ocorre quando uma aura, normalmente alguma forma de crowd control, é quebrado por dano de alguma habilidade.

A aura que foi quebrada é o que o ícone filtra por; a habilidade que a quebrou pode ser acessada com a substituição [Extra] na exibição de texto.]=] -- Needs review
L["CLEU_SPELL_DISPEL_DESC"] = [=[Ocorre quando uma aura é dispellada.

Ícone pode ser filtrado pela aura que foi dispellada. A habilidade que foi dispellada pode ser acessada com a substituição [Extra] na exibição de texto.]=] -- Needs review
...
L["ICONGROUP"] = "Ícone: %s (Grupo: %s)" -- Needs review
...
L["ICONMENU_ICDBDE"] = "Buff/Debuff/Dano/Energize/Invocação" -- Needs review
...
L["IMPORT_FROMBACKUP_DESC"] = "Opções restauradas desse menu ficarão como estavam às: %s" -- Needs review
...
L["IMPORT_PROFILE_OVERWRITE"] = "|cFFFF5959Sobrescrever|r %s" -- Needs review
...
L["SOUND_EVENT_ONDURATION_DESC"] = [=[Esse evento é acionado quando a duração de tempo do ícone muda.

Pelo fato do evento ocorrer toda você que o ícone é atualizado enquanto o tempo estiver correndo, você deve ditar uma condição, e o evento acontecerá quando o estado dessa condição mudar.]=] -- Needs review
L["SOUND_EVENT_ONFINISH_DESC"] = "Esse evento ativa quando a recarga torna-se usável, o debuff/buff acaba, etc." -- Needs review
L["SOUND_EVENT_ONSTACK_DESC"] = [=[Esse evento é acionado quando os stacks do que o ícone estiver rastreando são mudados

Isso inclui a quantidade de diminuimentos para %s ícones.]=] -- Needs review
